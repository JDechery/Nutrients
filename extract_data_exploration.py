...
def food_name(ndbno, food_df):
    name = food_df.loc[food_df['ndbno'].isin(ndbno)]['name']
    return name
...
pivotdf = quantities.pivot_table(index='food_id', columns='nutrient_id', values='value', fill_value=None, dropna=False)
